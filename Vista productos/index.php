...
<body>
    ...
    <div class="wrapper">
        <aside>
            <header>
                <h1 class="logo">Yarbe Ecommerce</h1>
            </header>
            <nav>
                <ul class="menu">
                    ...
                    <li><button class="boton-menu boton-categoria" id="Cardiovascular"><svg
                            ...
                            </svg> Cardiovascular</button></li>
                    <li><button class="boton-menu boton-categoria" id="Hematologia"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            </svg> Hematology</button></li>
                    <li><button class="boton-menu boton-categoria" id="Oncologia"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            </svg> Oncology</button></li>
                    <li><button class="boton-menu boton-categoria" id="Hormonal"><svg xmlns="http://www.w3.org/2000/svg"
                                width="16" height="16" fill="currentColor" class="bi bi-chat-right-dots-fill"
                                viewBox="0 0 16 16">
                                <path
                            ...
                            </svg> Hormonal</button></li>
                    <li><button class="boton-menu boton-categoria" id="Eye"><svg xmlns="http://www.w3.org/2000/svg"
