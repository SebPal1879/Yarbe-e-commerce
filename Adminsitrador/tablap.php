...
<div class="row">
    ...
    <div class="col-md-12">
        <table id="tabla" name="tabla" class="table table-hover table-condensed table-bordered">
            ...
            <?php
            $sql6 = "SELECT idp, titlep, imagep, codep, contentp, costp, namep, paymentp from producto";
            ...
            while ($ver = mysqli_fetch_row($result)) {
                ...
                <tr>
                    ...
                    <td>
                        <img src="../stock/<?php echo $ver[2] ?>" width="90">
                    </td>
                    <td>
                        <?php echo $ver[3] ?>
                    </td>
                    ...
                    <td>
                        <button class="btn btn-warning glyphicon glyphicon-pencil" data-bs-toggle="modal"
                            data-bs-target="#modalEditp"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
